...
void main() {
  ...
  group('Test provider', () {
    ...
    testWidgets('throws an error if no provider found', (tester) async {
      ...
      expect(
        ...
        isA<ProviderError>().having((err) => err.type, 'type', String),
      );
    });
    ...
    testWidgets(
      'update should notify has no effect if using Provider.factory',
      (tester) async {
        var buildCount = 0;
        int buildValue;
        final builder = Builder(
  ...
  group(
    ...
    () {
      testWidgets(
        'Providers children can only access parent providers',
        (tester) async {
          final k = GlobalKey();
          final k1 = GlobalKey();
          final k2 = GlobalKey();
  ...
  group('Test Consumer', () {
    testWidgets(
      'Obtains value from Provider<T> using Consumer',
      (tester) async {
        final key = GlobalKey();
    ...
    testWidgets(
      'Obtains value from Provider<T> using Consumer2',
      (tester) async {
        final key = GlobalKey();
    ...
    testWidgets(
      'Obtains value from Provider<T> using Consumer3',
      (tester) async {
        final key = GlobalKey();
